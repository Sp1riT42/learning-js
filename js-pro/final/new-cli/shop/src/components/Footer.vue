  ...
  <footer class="footer">
    <div class="footer__top center">
      <div class="footer__left">
        <img class="footer__photo" src="./../assets/img/footer-photo.png" alt="photo">
        <p class="footer__quote">“Vestibulum quis porttitor dui! Quisque viverra nunc mi, a pulvinar purus
          condimentum“</p>
      </div>
      <div class="footer__right">
        <h3 class="footer__heading">SUBSCRIBE</h3>
        <p class="footer__p">FOR OUR NEWLETTER AND PROMOTION</p>
        <form class="footer__form" action="#">
          <input type="email" class="footer__email" placeholder="Enter Your Email">
    ...
    <div class="footer__bottom center">
      ...
      <div class="footer__social">
        <a class="footer__icon__link" href="https://ru-ru.facebook.com/">
          <svg class="footer__icon" width="11" height="16" viewBox="0 0 11 16" fill="none"
               xmlns="http://www.w3.org/2000/svg">
            <path
                d="M9.08836 8.28L9.50686 5.61602H6.89022V3.88729C6.89022 3.15847 7.25574 2.44806 8.42765 2.44806H9.61722V0.179975C9.61722 0.179975 8.53772 0 7.50561 0C5.35073 0 3.9422 1.27593 3.9422 3.5857V5.61602H1.54688V8.28H3.9422V14.72H6.89022V8.28H9.08836Z" />
          </svg>
        </a>
        <a class="footer__icon__link" href="https://www.instagram.com/">
          <svg class="footer__icon" width="16" height="17" viewBox="0 0 16 17" fill="none"
               xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="footer__icon__link" href="https://www.pinterest.ru/">
          <svg class="footer__icon" width="13" height="16" viewBox="0 0 13 16" fill="none"
               xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="footer__icon__link" href="https://twitter.com/">
