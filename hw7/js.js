...
const map = {
  cells: null,
  usedCells: null,
  countEat: document.querySelector('#count-eat'),
  ...
  render(snakePointsArray, foodPoint, notFoodPoint) {
    ...
    snakePointsArray.forEach((point, index) => {
      ...
      this.countEat.textContent = `Счёт еды: ${this.usedCells.length}`
    ...
    const notFoodCell = this.cells[`x${notFoodPoint.x}_y${notFoodPoint.y}`];

    notFoodCell.classList.add('not-food');
    this.usedCells.push(notFoodCell);
    console.log(this.usedCells)
  },
};
...
const game = {
  ...
  reset() {
    ...
    this.notFood.setCoordinates(this.getRandomFreeCoordinates());
    this.render();
  },
  ...
  getRandomFreeCoordinates() {
    const exclude = [this.notFood.getCoordinates(), this.food.getCoordinates(), ...this.snake.getBody()];
    console.log(exclude)
  ...
  render() {
    this.map.render(this.snake.getBody(), this.food.getCoordinates(), this.notFood.getCoordinates());
  },
  ...
  tickHandler() {
    ...
    if (this.notFood.isOnPoint(this.snake.getNextStepHeadPoint())) {
      return this.finish();
    }
